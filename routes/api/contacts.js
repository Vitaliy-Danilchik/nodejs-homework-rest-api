...
router.put("/:contactId", authenticate, validateBody(schemas.addSchema), cntrl.updateContactById);

router.patch("/:contactId/favorite", validateBody(schemas.updateFavoriteSchema), cntrl.updateFavorite);
